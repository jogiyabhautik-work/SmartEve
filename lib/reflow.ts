import { AgendaItem, ReflowConflict, ReflowResult, ScheduleChange } from "@/types/agenda";
...
/**
 * Handles cancellation of an item and pulls subsequent schedule forward
 */
